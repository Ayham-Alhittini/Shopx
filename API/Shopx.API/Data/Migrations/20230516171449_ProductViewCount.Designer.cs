...
namespace User.Management.API.Migrations
{
    ...
    [Migration("20230516171449_ProductViewCount")]
    partial class ProductViewCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopx.API.Entities.BrowseHistory", b =>
                {
            ...
            modelBuilder.Entity("Shopx.API.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopx.API.Entities.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopx.API.Entities.ProductReviewVote", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "ProductReviewId");
            ...
            modelBuilder.Entity("Shopx.API.Entities.ReportProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopx.API.Entities.ShopReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shopx.API.Entities.ShopReviewVote", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "ShopReviewId");

                    b.HasIndex("ShopReviewId");

                    b.ToTable("ShopReviewVotes");
                });
            ...
            modelBuilder.Entity("Shopx.API.Entities.WishList", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Shopx.API.Entities.Notification", b =>
                {
                    b.HasOne("Shopx.API.Entities.AppUser", "User")
            ...
            modelBuilder.Entity("Shopx.API.Entities.ProductReviewVote", b =>
                {
                    b.HasOne("Shopx.API.Entities.ProductReview", "ProductReview")
                        .WithMany("ProductReviewVotes")
            ...
            modelBuilder.Entity("Shopx.API.Entities.ShopReviewVote", b =>
                {
                    b.HasOne("Shopx.API.Entities.ShopReview", "ShopReview")
                        .WithMany("ShopReviewVotes")
            ...
            modelBuilder.Entity("Shopx.API.Entities.AppUser", b =>
                {
                    ...
                    b.Navigation("ProductReviewVotes");
